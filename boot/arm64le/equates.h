...
#define tc_block_counter_disp 0x240
...
#define tc_current_mso_disp 0x250
...
#define tc_fpregs_disp 0x300
#define tc_fxfirst_bit_set_bv_disp 0x268
#define tc_fxlength_bv_disp 0x260
#define tc_gc_data_disp 0x330
...
#define tc_pb_call_arena_disp 0x330
#define tc_pb_fpregs_disp 0x330
#define tc_pb_regs_disp 0x330
...
#define tc_target_machine_disp 0x258
...
/* thread-context data */
#define DSTBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+752)))
#define SRCBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+760)))
...
#define ALLOCCOUNTER(x) (*((U64 *)TO_VOIDP((uptr)(x)+736)))
...
#define BLOCKCOUNTER(x) (*((ptr *)TO_VOIDP((uptr)(x)+576)))
...
#define COMPILEPROFILE(x) (*((ptr *)TO_VOIDP((uptr)(x)+632)))
#define COMPRESSFORMAT(x) (*((ptr *)TO_VOIDP((uptr)(x)+704)))
#define COMPRESSLEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+712)))
...
#define CURRENTMSO(x) (*((ptr *)TO_VOIDP((uptr)(x)+592)))
#define CURRENTOUTPUT(x) (*((ptr *)TO_VOIDP((uptr)(x)+560)))
#define DEFAULTRECORDEQUALPROCEDURE(x) (*((ptr *)TO_VOIDP((uptr)(x)+688)))
#define DEFAULTRECORDHASHPROCEDURE(x) (*((ptr *)TO_VOIDP((uptr)(x)+696)))
#define DISABLECOUNT(x) (*((ptr *)TO_VOIDP((uptr)(x)+512)))
#define EAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+160)))
#define ESP(x) (*((xptr *)TO_VOIDP((uptr)(x)+144)))
#define FPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+768))[i])
#define FXFIRSTBITSETBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+616)))
#define FXLENGTHBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+608)))
#define GCDATA(x) (*((xptr *)TO_VOIDP((uptr)(x)+816)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)TO_VOIDP((uptr)(x)+640)))
#define GENERATEPROCEDURESOURCEINFORMATION(x) (*((ptr *)TO_VOIDP((uptr)(x)+648)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)TO_VOIDP((uptr)(x)+656)))
#define GUARDIANENTRIES(x) (*((ptr *)TO_VOIDP((uptr)(x)+360)))
#define HANDLERSTACK(x) (*((ptr *)TO_VOIDP((uptr)(x)+440)))
#define INSTRCOUNTER(x) (*((U64 *)TO_VOIDP((uptr)(x)+728)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)TO_VOIDP((uptr)(x)+536)))
#define LZ4OUTBUFFER(x) (*((xptr *)TO_VOIDP((uptr)(x)+720)))
#define METALEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+624)))
#define OPTIMIZELEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+664)))
#define PARAMETERS(x) (*((ptr *)TO_VOIDP((uptr)(x)+744)))
#define PBCALLARENA(x,i) (((uptr *)TO_VOIDP((uptr)(x)+816))[i])
#define PBFPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+816))[i])
#define PBREGS(x,i) (((uptr *)TO_VOIDP((uptr)(x)+816))[i])
...
#define SFD(x) (*((ptr *)TO_VOIDP((uptr)(x)+584)))
...
#define SUBSETMODE(x) (*((ptr *)TO_VOIDP((uptr)(x)+672)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)TO_VOIDP((uptr)(x)+680)))
#define TARGETMACHINE(x) (*((ptr *)TO_VOIDP((uptr)(x)+600)))
