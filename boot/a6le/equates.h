...
#define tc_DSTBV_disp 0x2A0
#define tc_SRCBV_disp 0x2A8
#define tc_U_disp 0x178
#define tc_V_disp 0x180
#define tc_W_disp 0x188
#define tc_X_disp 0x190
#define tc_Y_disp 0x198
...
#define tc_block_counter_disp 0x1F0
#define tc_cached_frame_disp 0x170
...
#define tc_current_error_disp 0x1E8
#define tc_current_input_disp 0x1D8
#define tc_current_mso_disp 0x200
#define tc_current_output_disp 0x1E0
#define tc_default_record_equal_procedure_disp 0x260
#define tc_default_record_hash_procedure_disp 0x268
#define tc_disable_count_disp 0x1B0
#define tc_eap_disp 0x58
#define tc_esp_disp 0x48
#define tc_fpregs_disp 0x2B0
#define tc_fxfirst_bit_set_bv_disp 0x218
#define tc_fxlength_bv_disp 0x210
#define tc_gc_data_disp 0x2F0
...
#define tc_keyboard_interrupt_pending_disp 0x1C8
...
#define tc_pb_call_arena_disp 0x2F0
#define tc_pb_fpregs_disp 0x2F0
#define tc_pb_regs_disp 0x2F0
...
#define tc_sfd_disp 0x1F8
#define tc_sfp_disp 0x38
#define tc_signal_interrupt_pending_disp 0x1B8
#define tc_signal_interrupt_queue_disp 0x1C0
#define tc_something_pending_disp 0x1A0
...
#define tc_target_machine_disp 0x208
#define tc_td_disp 0x88
#define tc_threadno_disp 0x1D0
#define tc_timer_ticks_disp 0x1A8
...
/* thread-context data */
#define DSTBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+672)))
#define SRCBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+680)))
#define U(x) (*((ptr *)TO_VOIDP((uptr)(x)+376)))
#define V(x) (*((ptr *)TO_VOIDP((uptr)(x)+384)))
#define W(x) (*((ptr *)TO_VOIDP((uptr)(x)+392)))
#define X(x) (*((ptr *)TO_VOIDP((uptr)(x)+400)))
#define Y(x) (*((ptr *)TO_VOIDP((uptr)(x)+408)))
#define AC0(x) (*((xptr *)TO_VOIDP((uptr)(x)+40)))
#define AC1(x) (*((xptr *)TO_VOIDP((uptr)(x)+48)))
#define ACTIVE(x) (*((I32 *)TO_VOIDP((uptr)(x)+316)))
#define ALLOCCOUNTER(x) (*((U64 *)TO_VOIDP((uptr)(x)+656)))
...
#define BLOCKCOUNTER(x) (*((ptr *)TO_VOIDP((uptr)(x)+496)))
#define CACHEDFRAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+368)))
#define CCHAIN(x) (*((ptr *)TO_VOIDP((uptr)(x)+296)))
#define CODERANGESTOFLUSH(x) (*((ptr *)TO_VOIDP((uptr)(x)+304)))
#define COMPILEPROFILE(x) (*((ptr *)TO_VOIDP((uptr)(x)+552)))
#define COMPRESSFORMAT(x) (*((ptr *)TO_VOIDP((uptr)(x)+624)))
#define COMPRESSLEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+632)))
#define CP(x) (*((xptr *)TO_VOIDP((uptr)(x)+64)))
#define CURRENTERROR(x) (*((ptr *)TO_VOIDP((uptr)(x)+488)))
#define CURRENTINPUT(x) (*((ptr *)TO_VOIDP((uptr)(x)+472)))
#define CURRENTMSO(x) (*((ptr *)TO_VOIDP((uptr)(x)+512)))
#define CURRENTOUTPUT(x) (*((ptr *)TO_VOIDP((uptr)(x)+480)))
#define DEFAULTRECORDEQUALPROCEDURE(x) (*((ptr *)TO_VOIDP((uptr)(x)+608)))
#define DEFAULTRECORDHASHPROCEDURE(x) (*((ptr *)TO_VOIDP((uptr)(x)+616)))
#define DISABLECOUNT(x) (*((ptr *)TO_VOIDP((uptr)(x)+432)))
#define EAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+88)))
#define ESP(x) (*((xptr *)TO_VOIDP((uptr)(x)+72)))
#define FPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+688))[i])
#define FXFIRSTBITSETBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+536)))
#define FXLENGTHBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+528)))
#define GCDATA(x) (*((xptr *)TO_VOIDP((uptr)(x)+752)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)TO_VOIDP((uptr)(x)+560)))
#define GENERATEPROCEDURESOURCEINFORMATION(x) (*((ptr *)TO_VOIDP((uptr)(x)+568)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)TO_VOIDP((uptr)(x)+576)))
#define GUARDIANENTRIES(x) (*((ptr *)TO_VOIDP((uptr)(x)+288)))
#define INSTRCOUNTER(x) (*((U64 *)TO_VOIDP((uptr)(x)+648)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)TO_VOIDP((uptr)(x)+456)))
#define LZ4OUTBUFFER(x) (*((xptr *)TO_VOIDP((uptr)(x)+640)))
#define METALEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+544)))
#define OPTIMIZELEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+584)))
#define PARAMETERS(x) (*((ptr *)TO_VOIDP((uptr)(x)+664)))
#define PBCALLARENA(x,i) (((uptr *)TO_VOIDP((uptr)(x)+752))[i])
#define PBFPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+752))[i])
#define PBREGS(x,i) (((uptr *)TO_VOIDP((uptr)(x)+752))[i])
...
#define SFD(x) (*((ptr *)TO_VOIDP((uptr)(x)+504)))
#define SFP(x) (*((xptr *)TO_VOIDP((uptr)(x)+56)))
#define SIGNALINTERRUPTPENDING(x) (*((ptr *)TO_VOIDP((uptr)(x)+440)))
#define SIGNALINTERRUPTQUEUE(x) (*((ptr *)TO_VOIDP((uptr)(x)+448)))
#define SOMETHINGPENDING(x) (*((ptr *)TO_VOIDP((uptr)(x)+416)))
#define STACKCACHE(x) (*((ptr *)TO_VOIDP((uptr)(x)+328)))
#define STACKLINK(x) (*((ptr *)TO_VOIDP((uptr)(x)+336)))
#define SUBSETMODE(x) (*((ptr *)TO_VOIDP((uptr)(x)+592)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)TO_VOIDP((uptr)(x)+600)))
#define TARGETMACHINE(x) (*((ptr *)TO_VOIDP((uptr)(x)+520)))
#define TD(x) (*((xptr *)TO_VOIDP((uptr)(x)+136)))
#define THREADNO(x) (*((ptr *)TO_VOIDP((uptr)(x)+464)))
#define TIMERTICKS(x) (*((ptr *)TO_VOIDP((uptr)(x)+424)))
