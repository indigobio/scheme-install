...
#define tc_current_errno_source_disp 0x1F8
...
#define tc_pb_call_arena_disp 0x300
#define tc_pb_fpregs_disp 0x300
...
#define CURRENTERRNOSOURCE(x) (*((ptr *)TO_VOIDP((uptr)(x)+504)))
...
#define PBCALLARENA(x,i) (((uptr *)TO_VOIDP((uptr)(x)+768))[i])
#define PBFPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+768))[i])
